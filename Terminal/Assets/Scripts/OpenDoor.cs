...
public class OpenDoor : MonoBehaviour {
	...
	void  Update (){
        ...
        if (!doorWithoutKeyPlayed && ((Input.GetKeyDown(KeyCode.E)) || (Global.prevState.Buttons.A == ButtonState.Released && Global.state.Buttons.A == ButtonState.Pressed)) && enter && !hasKey) {
            Global.currentCue = 3;
